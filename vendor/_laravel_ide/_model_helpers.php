...
namespace App\Models {
    ...
    /**
     * App\Models\MenorprecoEstabelecimento
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $nr_logr
     * @property string|null $nm_logr
     * @property string|null $tp_logr
     * @property string $uf
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MenorprecoHistoricoPreco> $historicoPrecos
     * @property-read int|null $historicoPrecos_count
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereCodigo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereNomeFantasia($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereRazaoSocial($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereBairro($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereCidade($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereUf($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereTpLogr($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereNmLogr($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereNrLogr($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoEstabelecimento>|MenorprecoEstabelecimento query()
     ...
     */
    class MenorprecoEstabelecimento extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\MenorprecoHistoricoPreco
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property \Illuminate\Support\Carbon $data_coleta
     * @property \Illuminate\Support\Carbon $datahora_nota
     * @property float|null $distancia_km
     * @property float|null $desconto
     * @property float|null $preco_tabela
     * @property float $preco
     * @property mixed $estabelecimento_id
     * @property mixed $produto_id
     * @property int $id
     * @property-read \App\Models\MenorprecoProduto $produto
     * @property-read \App\Models\MenorprecoEstabelecimento $estabelecimento
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereProdutoId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereEstabelecimentoId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco wherePreco($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco wherePrecoTabela($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereDesconto($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereDistanciaKm($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereDatahoraNota($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereDataColeta($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoHistoricoPreco>|MenorprecoHistoricoPreco query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class MenorprecoHistoricoPreco extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\MenorprecoProduto
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MenorprecoHistoricoPreco> $historicoPrecos
     * @property-read int|null $historicoPrecos_count
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereGtin($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto wherePalavrachave($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereDescricao($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereNcm($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereVolume($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereUnidade($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereCategoria($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereLocal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MenorprecoProduto>|MenorprecoProduto query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class MenorprecoProduto extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
